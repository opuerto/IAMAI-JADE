        ...
        if(msg != null)
        {
            try
            {
                ...
                if (concept instanceof Intro)
                {
                    ...
                    System.out.println("started at "+introInstance.getIntroStartedAt());
                    System.out.println("started at from  "+getBehaviourName()+ " in millis " +introInstance.getIntroStartedAt());
